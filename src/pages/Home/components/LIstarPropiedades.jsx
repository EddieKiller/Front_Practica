import {
  ...
  function ListarPropiedades() {
    const [listadoPropiedades, setListadoPropiedades] = useState([]);
      ...
      const getData = async () => {
        try {
          const response = await fetch(
            "https://uk-property-data.p.rapidapi.com/propertytools.api.v1.Public/ListProperties"
          );
